...
def keyboard_input(blocks, input_complete, vibration_complete, distraction_complete):
    block_number = 0
    trial_number = 0
    ...
    for block in blocks:
        ...
        for trial in block.trials:
            ...
            while True:
                drawText(win, msg, "Press Enter to continue")
...
def vibration(blocks, input_complete, vibration_complete, distraction_complete):
    block_number = 0
    trial_number = 0
...
def distraction(blocks, input_complete, vibration_complete, distraction_complete):
    block_number = 0
    trial_number = 0
...
# start the threads
input_thread = threading.Thread(target=keyboard_input, args=(blocks, input_complete, vibration_complete, distraction_complete))
vibration_thread = threading.Thread(target=vibration, args=(blocks, input_complete, vibration_complete, distraction_complete))
distraction_thread = threading.Thread(target=distraction, args=(blocks, input_complete, vibration_complete, distraction_complete))
